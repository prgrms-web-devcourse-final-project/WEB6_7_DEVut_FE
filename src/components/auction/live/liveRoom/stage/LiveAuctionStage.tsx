    ...
    <div className="flex h-full min-w-0 flex-1 flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="flex flex-col">
          ...
          <div className="bg-bg-main border-border-sub2 sticky bottom-0 z-40 border-t">
            <div className="border-border-sub2 bg-custom-brown/30 text-title-main-dark flex h-12 shrink-0 items-center justify-between border-[3px] px-6 text-sm">
              <span>접속자: 284명</span>
