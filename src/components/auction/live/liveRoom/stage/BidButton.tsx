...
export default function BidButton() {
  return (
    <button className="group relative flex h-[clamp(110px,12vw,140px)] w-[clamp(110px,12vw,140px)] cursor-pointer items-center justify-center overflow-hidden rounded-full shadow-[0_14px_28px_rgba(0,0,0,0.7)] transition-all hover:scale-[1.02] active:translate-y-0.5">
